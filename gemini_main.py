...
def chat():
    ...
    try:
        ...
        **Image Insights (if available):**  
        ...
        followup_questions = []
        try:
            cleaned = followup_response.content.strip()
...
def invoke_with_retry(prompt, retries=3, delay=10):
    ...
    raise Exception("Failed after multiple retries due to quota exhaustion.")
